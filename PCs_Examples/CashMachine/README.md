...
* <i>PC_CardControl</i> introduces process <i>CardControl</i>, which provides an external choice of <i>cancel</i> and <i>cardIn</i>. Event <i>cardIn</i> triggers process <i>DoCardIn</i>.
